#ifndef PLOTWIDGET3_H
#define PLOTWIDGET3_H
...
class PlotWidget3 : public QWidget
{
    Q_OBJECT
public:
    explicit PlotWidget3(QWidget *parent = nullptr, QColor color_ = Qt::white, int xScale_ = 500, double y0_ = -20, double yScale_ = 20, int updateInterval_ = 5);
    ~PlotWidget3();
